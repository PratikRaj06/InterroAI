        ...
        <>
            <div ref={contentRef} className='w-full h-full flex flex-col items-center tracking-wide'>
                ...
                <div className='w-11/12 flex flex-col items-center gap-5 text-blue-dark'>
                    <h1 className='w-full py-5 text-3xl font-extrabold text-pink'>Resume Analysis Result</h1>
                    <div className='w-full h-full lg:p-5 p-3 rounded-lg bg-[#fdf4ff] grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 grid-rows-1 lg:gap-5 gap-3 border-[2px] border-pink border-opacity-25 place-items-center'>
                    ...
                    <div className='w-full flex flex-col items-center gap-5 py-5'>
                        <h1 className='w-full text-3xl font-bold text-purple'>Summary</h1>
            ...
            <Link to={'/home'} className='lg:w-1/4 w-1/2 text-center mt py-2 bg-pink-light text-purple rounded-lg border-[2px] border-purple'><HomeIcon/> Back to Home</Link>
            <button onClick={handleSavePdf} className='lg:w-1/4 w-1/2 py-2 text-center bg-purple text-white rounded-lg'><PictureAsPdfIcon/> {downloading? 'Downloading...' : 'Save as PDF'}</button>
            </div>
